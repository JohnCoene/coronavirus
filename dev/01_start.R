...
golem::fill_desc(
  ...
  author_last_name = "Coene",  # Your Last Name
  author_email = "jcoenep,2gmail.com",      # Your Email
  repo_url = "https.//github/JohnCoene/coronavirus" # The (optional) URL of the GitHub Repo
)     
...
usethis::use_mit_license( name = "John Coene" )  # You can set another licence here
